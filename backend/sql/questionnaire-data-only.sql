...
-- 清除已有数据（可选，保持干净的数据环境）
-- DELETE FROM base.tsys_answer WHERE answer_sheet_id IN (SELECT id FROM base.tsys_answer_sheet WHERE questionnaire_id = 1);
-- DELETE FROM base.tsys_answer_sheet WHERE questionnaire_id = 1;
-- DELETE FROM base.tsys_option WHERE questionnaire_id = 1;
-- DELETE FROM base.tsys_question WHERE questionnaire_id = 1;
-- DELETE FROM base.tsys_questionnaire;
